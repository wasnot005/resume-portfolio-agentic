...
function generateCSS(cfg: RenderConfigT) {
  ...
  return `:root{--background:${t.background||'0 0% 100%'};--foreground:${t.foreground||'0 0% 0%'};--primary:${t.primary||'217 91% 60%'};--primary-foreground:${t.primaryForeground||'0 0% 100%'};--accent:${t.accent||'210 40% 96%'};--muted:${t.muted||'215 20% 65%'};--radius:${t.radius||0}rem}body{margin:0;background:hsl(var(--background));color:hsl(var(--foreground));font:16px/1.6 system-ui,-apple-system,Segoe UI,Roboto,Inter,Arial}a{color:hsl(var(--primary))}.container{max-width:1100px;margin:0 auto;padding:24px}h1{font-size:clamp(28px,5vw,40px);margin:4px 0 8px}h2{font-size:22px;margin:32px 0 12px}h3{font-size:18px;margin:8px 0}p{margin:8px 0}.headline{color:hsl(var(--muted))}.tags{display:flex;flex-wrap:wrap;gap:8px;padding:0;margin:0;list-style:none}.tags li{background:hsl(var(--accent));border-radius:999px;padding:6px 10px;font-size:13px}.grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:16px}.card{background:hsl(var(--accent));border-radius:var(--radius);padding:16px}.links a{margin-right:12px}.xp{border-left:3px solid hsl(var(--muted));padding-left:12px;margin:12px 0}.edu{padding-left:18px}footer{color:hsl(var(--muted));margin-top:32px;border-top:1px solid hsl(var(--muted));padding-top:16px}`
}
